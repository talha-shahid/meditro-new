            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6 mb-30">
                <div className="heading-bx">
                  <h6 className="title-ext text-secondary">Expertise</h6>
                  <h2 className="title">
                    Experience The Power of Precision With PremierMedix
                  </h2>
                  <p>
                    Where expertise meets 100% revenue optimization for your
                    medical billing success.
                  </p>
                </div>
                <div className="row">
                  ...
                  <div className="col-lg-6 col-sm-6 mb-30 mb-sm-20">
                    <div className="feature-container feature-bx1 feature4">
                      ...
                      <div className="icon-content">
                        <h4 className="ttr-title">HIPAA Compliant 100%</h4>
                      </div>
                    </div>
                  </div>
                  <div className="col-lg-6 col-sm-6 mb-30 mb-sm-20">
                  ...
                  <div className="col-lg-6 col-sm-6 mb-30 mb-sm-20">
                    <div className="feature-container feature-bx1 feature4">
                      ...
                      <div className="icon-content">
                        <h4 className="ttr-title">Client Satisfaction 100%</h4>
                      </div>
                    </div>
                  </div>
                </div>
